...
private:
    ...
    auto run() -> void override
    {
        ...
        while(true)
        {
            ...
            if(commandName == "get")
            {
                HandleGetCommand(input.subspan(nCommandsParsed));
            }
            else if(commandName == "set")
            {
                HandleSetCommand(input.subspan(nCommandsParsed));
            }
            else if(commandName == "reset")
            {
                HandleResetCommand(input.subspan(nCommandsParsed));
            }
            else
            {
                HandleInvalidInput();
