...
#else
    #include <Sts1CobcSw/ChannelCoding/External/ConvolutionalCodingWithoutPuncturing.hpp>
#endif
...
#if !defined(USE_PUNCTURING)
TEST_CASE("Convolutional-Coding Without Pucturing")
{
    {
        static_assert(cc::ViterbiCodecWithoutPuncturing::EncodedSize(100, false) == 200);
        static_assert(cc::ViterbiCodecWithoutPuncturing::EncodedSize(100, true) == 202);
        static_assert(cc::ViterbiCodecWithoutPuncturing::EncodedSize(101, false) == 202);
        static_assert(cc::ViterbiCodecWithoutPuncturing::EncodedSize(101, true) == 204);
        static_assert(cc::ViterbiCodecWithoutPuncturing::EncodedSize(102, false) == 204);
        static_assert(cc::ViterbiCodecWithoutPuncturing::EncodedSize(102, true) == 206);

        static_assert(cc::ViterbiCodecWithoutPuncturing::UnencodedSize(152, false) == 76);
        static_assert(cc::ViterbiCodecWithoutPuncturing::UnencodedSize(152, true) == 74);
        static_assert(cc::ViterbiCodecWithoutPuncturing::UnencodedSize(153, false) == 76);
        static_assert(cc::ViterbiCodecWithoutPuncturing::UnencodedSize(155, false) == 76);
        static_assert(cc::ViterbiCodecWithoutPuncturing::UnencodedSize(156, false) == 78);
    }

    // Encode() returns the correct amount of data
    {
        auto cc = cc::ViterbiCodecWithoutPuncturing();
