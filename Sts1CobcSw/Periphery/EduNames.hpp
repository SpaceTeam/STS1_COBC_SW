...
{
// CEP command packets (see EDU PDD)
inline constexpr auto cmdAck = 0xd7;  /*! Acknowledging a data packet */
inline constexpr auto cmdNack = 0x27; /*! Not Acknowledging an invalid data packet */
...
// CRC32 constants
inline constexpr auto crc32Poly = 0x04c11db7; /*! Generator polynomial for CRC32 checksums */
inline constexpr auto crc32Init = 0xffffffff; /*! Initial CRC32 value */

/**
 * CRC32 lookup table for polynomial 0x04c11db7 (MPEG2), see https://gist.github.com/Miliox/b86b60b9755faf3bd7cf
 */
inline constexpr uint32_t crcTable[256] = {
