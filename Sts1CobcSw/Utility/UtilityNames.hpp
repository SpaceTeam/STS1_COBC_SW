...
inline constexpr auto uint32SecondByteMask = 0x00FF0000U;
inline constexpr auto uint32ThirdByteMask = 0x0000FF00U;
inline constexpr auto uint32FourthByteMask = 0x000000FFU;

// Byte masks for uint16_t
inline constexpr auto uint16FirstByteMask = 0xFF00U;
inline constexpr auto uint16SecondByteMask = 0x00FFU;

// Byte width constants
inline constexpr auto oneByteWidth = 8U;
inline constexpr auto twoBytesWidth = 16U;
