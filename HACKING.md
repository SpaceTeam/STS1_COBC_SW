...
hidden if the `CobcSw_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `CobcSw_DEVELOPER_MODE` to the configure
...
Runs the executable target `CobcSw_exe`.
